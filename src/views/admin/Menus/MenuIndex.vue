      ...
      <ComponentCard title="">
        <template #header>
          <div class="flex justify-between items-center">
            <h2></h2>
            <router-link to="/admin/menus/create" class="bg-blue-500 text-white px-3 py-1 rounded">
              New Menu
            </router-link>
          </div>
        </template>
        ...
        <MenuTable :menus="menus" @refresh="fetchData" />
      </ComponentCard>
    </div>
  </AdminLayout>
</template>
...
import MenuTable from '@admin/Menus/MenuTable.vue'
...
const currentPageTitle = ref('All Menus')
