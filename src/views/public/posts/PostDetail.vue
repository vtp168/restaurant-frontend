                        ...
                        <div class="w-full bg-white">
                            <div class="mb-6">
                                <div class="p-4 bg-gray-100">
                                    <h2 class="text-lg font-bold">អត្តបទទាក់ទង</h2>
                                </div>
                                <ul class="post-number" v-for="(item,idx) in post.related_posts" :key="idx">
                                    <router-link :to="`/article/detail/${item.id}`">
                                    <li class="border-b border-gray-100 hover:bg-gray-50">
                                        <div class="flex flex-row p-1">
                                            <img class="w-20 h-20 object-cover" :src="imgPath+'/'+item.thumbnail" alt="Post Thumbnail">
                                            <div class="ml-4">
